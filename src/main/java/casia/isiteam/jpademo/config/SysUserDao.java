package casia.isiteam.jpademo.config;
...
@EnableJpaRepositories(
        ...
        basePackages= { "casia.isiteam.jpademo.model.po.sysuser" }) //设置Repository所在位置
public class SysUserDao {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryUser (EntityManagerFactoryBuilder builder) {
        return builder.
                ...
                .packages("casia.isiteam.jpademo.model.po.sysuser") //设置实体类所在位置
